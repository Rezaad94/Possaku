...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - Nomor Handphone62xxxxxxxxxx</name>
   <tag></tag>
...
+62xxxxxxxxxx</value>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'Nomor Handphone
+62xxxxxxxxxx' or . = 'Nomor Handphone
