...
Mobile.tap(findTestObject('Object Repository/Login/LinkLogin'), 0)

Mobile.tap(findTestObject('Login/TapInput - Nomor Handphone'), 0)

'invalid phone number'
Mobile.setText(findTestObject('Login/SetText - Nomor Handphone'), '0856222222', 0)

Mobile.tap(findTestObject('Login/TapInputPIN'), 0)

'invalid PIN'
Mobile.setText(findTestObject('Login/SetTextPIN'), '111111', 0)

Mobile.tap(findTestObject('Login/LoginButton'), 0)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Login/PopFailedLogin'), 0)
