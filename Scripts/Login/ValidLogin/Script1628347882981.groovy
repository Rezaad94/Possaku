...
Mobile.setText(findTestObject('Login/SetText - Nomor Handphone'), '08562540864', 0)

Mobile.tap(findTestObject('Login/TapInputPIN'), 0)

Mobile.setText(findTestObject('Login/SetTextPIN'), '123456', 0)

Mobile.tap(findTestObject('Login/LoginButton'), 0)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.waitForElementPresent(findTestObject('Login/SearchProduk'), 0)
